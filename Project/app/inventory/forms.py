...
class ProductForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'unit':         forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'ej: litros, unidades, kg'}),
            'min_stock':    forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'step': '0.01'}),
        }
...
class LotForm(forms.ModelForm):
    class Meta:
        model = Lot
        fields = ['product', 'quantity', 'expiration_date', 'supplier', 'cost']
        labels = {
            'product':         'Producto',
            'quantity':        'Cantidad',
